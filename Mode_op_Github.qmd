...
-   Maintenant, on doit **cloner ce repository sur Rstudio**:
    ...
    -   Sur **GitHub / Code**, dans le repository créé, il faut recopier le protocole HTTPS (ou SSH) :
        ...
        -   Dans RStudio, sous **File - New Project - Version Control - Git**, recopier le protocole dans le "Repository URL", le cas échéant, choisir le répertoire qui contiendra le projet dans l'ordinateur. Project_directory_name est par défaut le nom du .git
